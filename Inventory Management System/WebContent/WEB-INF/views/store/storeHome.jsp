    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                <button  onclick="clicked('warehouseStock')" class="list-group-item list-group-item-action bg-transparent second-text active"><i
                        class="fas fa-tachometer-alt me-2"></i>Store Stock</button>
       <div class="dropdown">       
        <button  class="list-group-item list-group-item-action bg-transparent second-text fw-bold dropdown-toggle" role="button" id="grnDropdown" data-bs-toggle="dropdown" aria-expanded="false">
          <i class="fas fa-gift me-2"></i>Indents
        </button> 
         <ul class="dropdown-menu" aria-labelledby="grnDropdown">
            <li><button class="dropdown-item"  onclick="clicked('getStoreIndents')">List Indent</button></li>
            <li><button class="dropdown-item"  onclick="clicked('createStoreIndent')">Create Indent</button></li>
          </ul>
        </div>
