...
public class ProductControllers {
	...
	public @ResponseBody List<ProductStockData> getProductsIDs(
	...
	// categoryRequest = objectMapper.readValues(categoryInputModel, CategoryRequest.class);
	// } catch (Exception e) {
	// e.printStackTrace();
	// }
	//
	...
	public @ResponseBody ProductStockData getProductQuantityOrPrice(
		...
		try {
			...
			quantityOrPrice = productsDAO
					.getQuantityandpriceByProductIdOrBatchNo(productsProductIdandBatchNoInputModel);
	...
	@ResponseBody
	public void saveCategory(@ModelAttribute("categoryInputModel") CategoryRequest2 categoryInputModel)
			throws Exception {
