...
public class StoreIndentController {
	...
	ObjectMapper objectMapper; // Creating an instance of ObjectMapper

	private static final Logger logger = LoggerFactory.getLogger(StoreIndentController.class);

	@Autowired
	public StoreIndentController(StoreIndentsDao storeIndentsDao, StoreService storeService, ModelMapper modelMapper,
			ObjectMapper objectMapper) {
		super();
		this.storeIndentsDao = storeIndentsDao;
